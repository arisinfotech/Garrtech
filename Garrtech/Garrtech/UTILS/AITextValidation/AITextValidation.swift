...
class AITextValidation: NSObject {
    ...
    func blankTextValidation(validationType : validationTYPE) {
        ...
        else if case .AI_VALIDATION_TYPE_FIRST_NAME = validationType {
            message = message_First_Name_Blank
        }
        else if case .AI_VALIDATION_TYPE_LAST_NAME = validationType {
            message = message_Last_Name_Blank
        }
        else{
            message = message_Default_Blank
        }
    ...
    func validTextLengthValidation(validationType : validationTYPE) {
        ...
        if case .AI_VALIDATION_TYPE_NAME = validationType {
            ...
            message = message_First_Name_NotValid
        }
        else if case .AI_VALIDATION_TYPE_LAST_NAME = validationType {
            message = message_Last_Name_NotValid
        }
        else{
            message = message_Default_Blank
        }
...
let message_First_Name_Blank = "Please enter firstname"
let message_First_Name_NotValid = "Please enter valid firstname"

let message_Last_Name_Blank = "Please enter lastname"
let message_Last_Name_NotValid = "Please enter valid lastname"
