...
//  Spotliss
//
//  Created by Aris-mac on 07/07/16.
...
extension Character {
    func isEmoji() -> Bool {
        ...
        return Character(UnicodeScalar(0x1d000 as UInt32)!) <= self && self <= Character(UnicodeScalar(0x1f77f  as UInt32)!)
            || Character(UnicodeScalar(0x1f900  as UInt32)!) <= self && self <= Character(UnicodeScalar(0x1f9ff  as UInt32)!)
            || Character(UnicodeScalar(0x2100  as UInt32)!) <= self && self <= Character(UnicodeScalar(0x26ff  as UInt32)!)
...
extension NSDictionary{
    ...
    func dictionaryByReplacingNullsWithBlanks() -> NSMutableDictionary {
        ...
        let blank : NSString = ""
        for key : AnyObject in self.allKeys as Array{
